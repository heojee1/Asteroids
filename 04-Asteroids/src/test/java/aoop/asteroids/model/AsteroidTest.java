...
import aoop.asteroids.model.game_object.AsteroidSize;
...
class AsteroidTest {
	...
	private Asteroid generateRandomAsteroid() {
		...
		return new Asteroid(
				new Point.Double(rng.nextDouble(GameFrame.WINDOW_SIZE.width), rng.nextDouble(GameFrame.WINDOW_SIZE.height)),
